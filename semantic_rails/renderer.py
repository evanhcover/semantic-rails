...
readable SQL string returned by ``compile``, ``query``, and the
website's "rendered SQL" preview. Dialect-specific function and
keyword choices come from :mod:`semantic_rails.dialects` — this module
owns layout, indentation, identifier quoting, and CTE ordering.
"""
