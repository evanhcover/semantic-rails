...
lives at [`schemas/query_ir.v1.json`](../schemas/query_ir.v1.json). It is a
JSON Schema Draft 2020-12 document. This page is the narrative companion —
read it first, then point your validator at the JSON file.
...
| Field | Type | Notes |
|---|---|---|
| `version` | `integer` (`1` or `2`) | Pin the IR schema version. `1` is the canonical published shape; `2` is the enriched runtime draft shape used by planner outputs such as scoped aggregates and period shifts. Unsupported versions are rejected. |
