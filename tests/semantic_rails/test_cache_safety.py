...
def test_runtime_set_compile_cache_accepts_protocol_implementation(runtime_factory):
    ...
    the in-process LRU with a protocol-conforming backend. Hosted operators
    use this to inject Redis / Memcached / etc. The underscore-prefixed
    attribute stays internal (state), the setter is the contract.
    """
